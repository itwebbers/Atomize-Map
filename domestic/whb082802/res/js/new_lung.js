...
/*以下市级地图部分*/
function queryCityData(cityJson) {
    var data = {
        "useDeviceNum": 48,
        "deviceNum": 144,
        "timeDataArray": [
        ...
        "hosTenMinList": [{
            ...
            "attrValues": ["è‹å·žå„¿ç«¥åŒ»é™¢å›­åŒº", 1, "", 16, ""]
        }, {
            "attrs": {
                "HOSPITAL_NAME": "发的规范规范公司法放到",
                "LAST_TEN_MIN_USE": 1,
                "HOSPITAL_LEVEL": "äºŒçº§åŒ»é™¢",
                "TODAY_USE_NUM": 6,
                "COORDINATE": "120.551187,31.444056"
            },
            "attrsEntrySet": [{
                ...
                "value": "120.551187,31.444056",
                "key": "COORDINATE"
            }],
            "attrNames": ["HOSPITAL_NAME", "LAST_TEN_MIN_USE", "HOSPITAL_LEVEL", "TODAY_USE_NUM", "COORDINATE"],
            "attrValues": ["ç›¸åŸŽåŒºç¬¬äºŒäººæ°‘åŒ»é™¢", 1, "äºŒçº§åŒ»é™¢", 6, "120.551187,31.444056"]
        }, {
            "attrs": {
                "HOSPITAL_NAME": "的广泛地飞飞",
                "LAST_TEN_MIN_USE": 1,
                "HOSPITAL_LEVEL": "äºŒçº§åŒ»é™¢",
                "TODAY_USE_NUM": 2,
                "COORDINATE": "121.031838,31.524407"
            },
            "attrsEntrySet": [{
                ...
                "value": "121.031838,31.524407",
                "key": "COORDINATE"
            }],
            "attrNames": ["HOSPITAL_NAME", "LAST_TEN_MIN_USE", "HOSPITAL_LEVEL", "TODAY_USE_NUM", "COORDINATE"],
            "attrValues": ["å¤ªä»“æµæ²³äººæ°‘åŒ»é™¢", 1, "äºŒçº§åŒ»é™¢", 2, "121.031838,31.524407"]
        }, {
            "attrs": {
                "HOSPITAL_NAME": "发的发的身份的",
                "LAST_TEN_MIN_USE": 1,
                "HOSPITAL_LEVEL": "ä¸‰çº§åŒ»é™¢",
                "TODAY_USE_NUM": 2,
                "COORDINATE": "120.590469,31.302114"
            },
            "attrsEntrySet": [{
                ...
                "value": "120.590469,31.302114",
                "key": "COORDINATE"
            }],
            "attrNames": ["HOSPITAL_NAME", "LAST_TEN_MIN_USE", "HOSPITAL_LEVEL", "TODAY_USE_NUM", "COORDINATE"],
            "attrValues": ["è‹å·žå¤§å­¦é™„å±žç¬¬äºŒåŒ»é™¢", 1, "ä¸‰çº§åŒ»é™¢", 2, "120.590469,31.302114"]
        }]
    };
    if (data) {
        ...
        if (data.dataNum >= 0) {
            ...
            for (var key in dataList) {
                ...
                var value = dataList[key].toString();
                dataArrayMap[intTopTen] = {
                    value: value,
                    name: hosName
                };
                intTopTen++;
            ...
            var hos_top = {
                target: 'hos_top_10',
                title: city + '各医院肺功能次数TOP10',
                dataArray: dataArrayMap
            };
            initHostop(hos_top);


            /*过去十分钟内全市地图相关数据  name 随便传进来一个就可以 type同一均为三级医院 geoCoord各省传一个坐标进来*/
...
function flexslider() {
    ...
    $('#atomization_number,#atomization_percent,#atomization_number1,#atomization_percent1,#atomization_number2').numberAnimate();
    TODAY_USE_TIMES = 638;
    $('#atomization_number').numberAnimate('set', TODAY_USE_TIMES);
    var num1 = 101;
    var num2 = 180;
    var percent = parseInt((num2 / TODAY_USE_TIMES) * 100);
    console.log(percent)
    TODAY_JHL = parseInt((num1 / TODAY_USE_TIMES) * 100);
    $('#atomization_number1').numberAnimate('set', num1);
    $('#atomization_percent1').numberAnimate('set', percent);
    $('#atomization_percent').numberAnimate('set', TODAY_JHL);
    $('#atomization_number2').numberAnimate('set', num2);
    setInterval(function () {
        /*雾化地图处理*/
        var newCount = parseInt(Math.random(0, 1) * 100);
        TODAY_USE_TIMES += newCount;
        TODAY_JHL++;
        num1 += parseInt(Math.random(0, 1) * 10);
        num2 += parseInt(Math.random(0, 1) * 20);
        // percent += 1;
        percent = parseInt((num2 / TODAY_USE_TIMES) * 100);
        TODAY_JHL = parseInt((num1 / TODAY_USE_TIMES) * 100);
        var atomization_number_pagent = $('#atomization_number').parent();
        var atomization_percent_pagent = $('#atomization_percent').parent();
        var atomization_number_pagent1 = $('#atomization_number1').parent();
        var atomization_percent_pagent1 = $('#atomization_percent1').parent();
        var atomization_number_pagent2 = $('#atomization_number2').parent();
        atomization_number_pagent.html('');
        atomization_percent_pagent.html('');
        atomization_number_pagent1.html('');
        atomization_percent_pagent1.html('');
        atomization_number_pagent2.html('');

        atomization_number_pagent.append('<i id="atomization_number"></i>次');
        atomization_percent_pagent.append('占比<i id="atomization_percent"></i>%');
        atomization_number_pagent1.append('<i id="atomization_number1"></i>次');
        atomization_number_pagent2.append('<i id="atomization_number2"></i>次');
        atomization_percent_pagent1.append('占比<i id="atomization_percent1"></i>%');
        $('#atomization_number,#atomization_percent,#atomization_number1,#atomization_percent1,#atomization_number2').numberAnimate();
        $('#atomization_number').numberAnimate('set', TODAY_USE_TIMES);
        $('#atomization_percent').numberAnimate('set', TODAY_JHL);
        $('#atomization_number1').numberAnimate('set', num1);
...
init_Provicnce_page = function () {
    var provinceJson = {
        ...
        "hosTenMinList": [{
                ...
                "attrNames": ["HOSPITAL_NAME", "LAST_TEN_MIN_USE", "HOSPITAL_LEVEL", "TODAY_USE_NUM", "COORDINATE"],
                "attrValues": ["无锡儿童医院", 4, "三级医院", 164, "120.331698,31.54611"]
            }, {
                "attrs": {
                ...
                "attrNames": ["HOSPITAL_NAME", "LAST_TEN_MIN_USE", "HOSPITAL_LEVEL", "TODAY_USE_NUM", "COORDINATE"],
                "attrValues": ["江苏市人民医院", 1, "三级医院", 3, "120.162011,32.513263"]
            }, {
                "attrs": {
                ...
                "attrNames": ["HOSPITAL_NAME", "LAST_TEN_MIN_USE", "HOSPITAL_LEVEL", "TODAY_USE_NUM", "COORDINATE"],
                "attrValues": ["常州子奇医院", 1, "三级医院", 149, "119.974061,31.811226"]
            }, {
                "attrs": {
                ...
                "attrNames": ["HOSPITAL_NAME", "LAST_TEN_MIN_USE", "HOSPITAL_LEVEL", "TODAY_USE_NUM", "COORDINATE"],
                "attrValues": ["连云港紫麒麟医院", 1, "二级医院", 408, "119.221611,34.596653"]
            }, {
                "attrs": {
                    "HOSPITAL_NAME": "宿迁市人民医院",
                    "LAST_TEN_MIN_USE": 3,
                ...
                "attrNames": ["HOSPITAL_NAME", "LAST_TEN_MIN_USE", "HOSPITAL_LEVEL", "TODAY_USE_NUM", "COORDINATE"],
                "attrValues": ["南通市人民医院", 1, "二级医院", 608, "120.894676,31.981143"]
            }, {
                "attrs": {
                    "HOSPITAL_NAME": "苏州市同济医院",
                    "LAST_TEN_MIN_USE": 3,
                    "HOSPITAL_LEVEL": "三级医院",
                    "TODAY_USE_NUM": 608,
                    "COORDINATE": "120.585728, 31.2974"
    ...
    $('#hos_top_10').remove();
    $('#title_name').html(province + '省今日肺功能实时数据');
...
function queryProvinceData(provinceJson) {
    ...
    if (data) {
        ...
        var timeDataArray = {
            title: province + '省肺功能检测实时数据-时间曲线',
            yData: timeDataArrayDataY
        };
        ...
        if (data.dataNum >= 0) {
            ...
            var hos_top = {
                target: 'hos_top_5',
                title: province + '省各医院今日肺功能检测次数TOP5',
                dataArray: [{
                        value: parseInt(Math.random(0, 1) * 50, 10),
                        name: '无锡市儿童医院'
                    },
                    {
                        value: parseInt(Math.random(0, 1) * 50, 10),
            ...
            var city_top = {
                target: 'city_top_5',
                title: '各市今日肺功能检测次数TOP5',
                dataArray: [{
                        value: parseInt(Math.random(0.9, 1) * 100, 10),
                        name: '苏州'
                    },
                    {
                        value: parseInt(Math.random(0.9, 1) * 100, 10),
            ...
            //对echarts传入的对象中的数组进行排序
            var newDataArray = city_top.dataArray;
            newDataArray = newDataArray.sort(function (v1, v2) {
                a = v1.value;
                b = v2.value;
                if (a > b) {
            ...
            var city_top = {
                target: 'city_top_5',
                title: province + '医院今日肺功能检测次数TOP5',
                dataArray: cityMap
            };
            // initCitytop(city_top);
...
add_pop = function (obj) {
    ...
    var wid = 'min_pop'; /*医院使用频繁度 对应的圆圈大小*/
    ...
    var span = '<div id=' + timer + ' class="pop_tips" style="left:' + obj.data.x + 'px;top:' + obj.data.y + 'px; ">' +
        '<div class="pop_title"><span class="pop_name">' + obj.name + '</span><span class="pop_val" style="color: #' + font_col + ';">+<i>' + obj.value + '</i></span></div>' +
        '<span class="pop ' + wid + '" style="background-color: #' + bg_col + ';"></span></div>';
    $('.main').append(span);
    setTimeout(function () {
        $('#' + timer).remove();
    }, 5000);
        ...
        function (ec) {
            ...
            var timeChartOption = {
                title: {
                    ...
                    padding: 15, // 标题内边距，单位px，默认各方向内边距为5，
                    // 接受数组分别设定上右下左边距，同css
                    textStyle: {
                        fontSize: 16,
                        color: '#333' // 主标题文字颜色
